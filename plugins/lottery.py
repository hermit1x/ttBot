...
async def auto_buy(event, bot):
    ...
    for i in lottery_db:
        ...
        time.sleep(0.2)
        await bot.send_private_msg(user_id = 2063942797, message = msg)
        # 找幼女控买彩票